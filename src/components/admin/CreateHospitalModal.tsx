...
import { createHospitalSchema, type CreateHospitalFormData } from '@/lib/validations/hospital'
...
export default function CreateHospitalModal({ open, onClose }: CreateHospitalModalProps) {
  ...
  const createMutation = useMutation({
    mutationFn: (data: CreateHospitalFormData) => hospitalApi.create(data),
    onSuccess: () => {
      toast({
        title: 'Success',
    ...
    onError: (error: unknown) => {
      const message = extractErrorMessage(error, 'Failed to create hospital')
      toast({
        title: 'Error',
        description: message,
        variant: 'destructive',
  ...
  const onSubmit = (data: CreateHospitalFormData) => {
