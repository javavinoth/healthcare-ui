    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-light px-4 py-12">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-body text-neutral-blue-gray">Create your patient account</p>
        </div>
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
              ...
              <div className="space-y-2">
                ...
                />
                {errors.phoneNumber && (
                  <p id="phoneNumber-error" className="text-sm text-error" role="alert">
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword">
                  Confirm Password <span className="text-error" aria-label="required">*</span>
                </Label>
                <div className="relative">
                  <Input
                    id="confirmPassword"
              ...
              <Button
                type="submit"
                className="w-full"
                disabled={isSubmitting || registerMutation.isPending || registerSuccess}
              >
