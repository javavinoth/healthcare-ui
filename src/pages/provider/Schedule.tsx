...
export default function Schedule() {
  ...
  return (
    <div className="h-screen flex flex-col bg-neutral-light">
      <AppHeader title="Schedule Management" showBackButton backPath="/provider/dashboard" />
                ...
                <div className="bg-warning/10 border border-warning/30 rounded-lg p-4 flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-warning/80">
                      You currently have no days enabled in your schedule. Patients will not be able
                      to book appointments with you. Use the "Quick Actions" below to quickly set up
                      your availability.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-wellness/10 border border-wellness/20 rounded-lg p-4 flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-wellness/80">
                      You have <strong>{activeDaysCount}</strong>{' '}
                      {activeDaysCount === 1 ? 'day' : 'days'} enabled. Patients can book
                      appointments during your available hours.
                    </p>
                  </div>
                </div>
              )}
            ...
            <TabsContent value="availability" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Set your working hours for each day of the week. Patients can only book
                    appointments during your available hours.
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="timeoff" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Request time off for vacations, conferences, or personal days. Pending requests
            ...
            <TabsContent value="settings" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure your appointment slot duration. This determines how long each
                    appointment booking will be.
                  </CardDescription>
                </CardHeader>
                <CardContent>
