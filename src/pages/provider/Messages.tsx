 ...
 * Secure messaging interface for healthcare providers
 * Features:
          ...
          {selectedConversationId ? (
            ...
            <div className="flex-1 flex items-center justify-center">
              <EmptyState
                ...
                description="Choose a conversation from the list to view and respond. Patients can initiate new conversations with you."
              />
            </div>
          )}
        </main>
