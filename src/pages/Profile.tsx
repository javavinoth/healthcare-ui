              ...
              <CardContent>
                ...
                <form onSubmit={handleProfileSubmit(onProfileSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-neutral-blue-gray">Format: +[country code][number]</p>
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <form onSubmit={handlePasswordSubmit(onPasswordSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className={passwordErrors.currentPassword ? 'border-error pr-12' : 'pr-12'}
                      />
                      <button
                        type="button"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className={passwordErrors.confirmNewPassword ? 'border-error pr-12' : 'pr-12'}
                      />
                      <button
                        type="button"
                  ...
                  >
                    {isPasswordSubmitting || changePasswordMutation.isPending ? 'Changing...' : 'Change Password'}
                  </Button>
                </form>
              </CardContent>
            </Card>
              ...
              <CardContent>
                ...
                <div className="space-y-4">
                  ...
                  {!user.twoFactorEnabled && !qrCodeUrl && (
                    <Button onClick={handleEnable2FA} className="w-full" disabled={enable2FAMutation.isPending}>
                  ...
                  {qrCodeUrl && (
                    <div className="space-y-4">
                      <div className="text-center">
                        <p className="text-sm mb-4">Scan this QR code with Google Authenticator:</p>
